  ...
  theme: {
    extend: {
      colors: {
        ...
        primary: {
          DEFAULT: 'var(--color-primary, #0052D9)',
          foreground: 'var(--color-primary-foreground, #FFFFFF)',
          hover: 'var(--color-primary-hover, #0044B8)',
          active: 'var(--color-primary-active, #00388F)',
          soft: 'var(--color-primary-soft, #E8F1FF)',
          dark: 'var(--color-primary-dark, #5B9CFF)',
          'dark-foreground': 'var(--color-primary-dark-foreground, #020617)',
          'dark-hover': 'var(--color-primary-dark-hover, #7DB2FF)',
          'dark-active': 'var(--color-primary-dark-active, #A7C7FF)',
          'dark-soft': 'var(--color-primary-dark-soft, #0B2D5F)',
        },
        success: {
          DEFAULT: '#26B899',
          foreground: '#FFFFFF',
