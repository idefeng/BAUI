...
const financeDashboardData: MockFinanceDashboardData = {
  balance: '¥12,450',
  chart: [
    { label: '周日', savings: 10, income: 12, expenses: 3 },
    { label: '周一', savings: 8, income: 10, expenses: 2 },
    { label: '周二', savings: 11, income: 15, expenses: 3 },
    { label: '周三', savings: 19, income: 15, expenses: 4, active: true },
    { label: '周四', savings: 14, income: 17, expenses: 3 },
    { label: '周五', savings: 18, income: 21, expenses: 6 },
    { label: '周六', savings: 22, income: 24, expenses: 6 },
  ],
  summary: [
    { label: '总收入', value: '¥15,000', trend: 'up', trendText: '较上月 +5.1%' },
    { label: '总支出', value: '¥6,700', trend: 'down', trendText: '较上月 +15.5%' },
    { label: '储蓄余额', value: '¥8,300', trend: 'up', trendText: '较上月 +20.7%' },
  ],
  spendingLimit: {
    label: '月度支出上限',
    used: 8600,
  ...
  budgetTip: {
    title: '用这些快捷建议优化预算',
    description: '为 2025 年税务季提前准备，建议预留 10-15% 作为扣除项资金。',
  },
  costAnalysis: {
    month: '1月',
    total: '¥8,450',
    categories: [
      { label: '住房', percent: 18, tone: 'warning' },
      { label: '债务还款', percent: 7, tone: 'warning' },
      { label: '餐饮', percent: 6, tone: 'primary' },
      { label: '交通', percent: 9, tone: 'success' },
      { label: '医疗', percent: 10, tone: 'success' },
      { label: '投资', percent: 17, tone: 'success' },
      { label: '其他', percent: 33, tone: 'gray' },
    ],
  },
  financialHealth: {
    total: '¥15,780',
    trendText: '较上月 +17.5%',
    score: 75,
    description: '基于过去 30 天聚合交易指标计算',
  },
  goals: [
    { id: 'reserve', label: '备用金', current: 7000, target: 10000, helperText: '还需储蓄 4 个月', tone: 'success' },
    { id: 'travel', label: '旅行', current: 2500, target: 4000, helperText: '还需储蓄 3 个月', tone: 'warning' },
    { id: 'car', label: '购车', current: 1600, target: 20000, helperText: '还需储蓄 3 年 6 个月', tone: 'warning' },
    { id: 'real-estate', label: '房产', current: 8300, target: 70000, helperText: '还需储蓄 5 年 8 个月', tone: 'warning' },
  ],
  quickPayments: [
    { id: 'davis', name: '戴维', initials: '戴', tone: 'primary' },
    { id: 'elli', name: '艾莉', initials: '艾', tone: 'warning' },
    { id: 'leo', name: '雷欧', initials: '雷', tone: 'gray' },
    { id: 'amanda', name: '阿曼达', initials: '阿', tone: 'success' },
    { id: 'ann', name: '安安', initials: '安', tone: 'warning' },
    { id: 'sin', name: '辛一', initials: '辛', tone: 'primary' },
  ],
  transactions: [
    { id: 'dividend', name: '分红入账', date: '2025年2月25日', amount: '+ ¥1,100', status: '已完成', tone: 'success' },
    { id: 'subscriptions', name: '企业订阅', date: '2025年2月25日', amount: '- ¥6,400', status: '已拒绝', tone: 'danger' },
    { id: 'etf', name: 'ETF 投资', date: '2025年2月21日', amount: '- ¥900', status: '已完成', tone: 'gray' },
    { id: 'consulting', name: '咨询服务', date: '2025年2月21日', amount: '- ¥2,100', status: '已完成', tone: 'primary' },
    { id: 'equipment', name: '设备采购', date: '2025年2月20日', amount: '- ¥1,700', status: '已完成', tone: 'warning' },
    { id: 'elli-harper', name: '艾莉转账', date: '2025年2月15日', amount: '+ ¥600', status: '已完成', tone: 'warning' },
    { id: 'davis-rowen', name: '戴维转账', date: '2025年2月15日', amount: '+ ¥800', status: '已完成', tone: 'primary' },
  ],
};
